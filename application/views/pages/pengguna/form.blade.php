...
<section class="content">
    <div class="container-fluid">
        <form role="form" action="{{ @$info ? site_url('pengguna/update/'.$info->id) : site_url('pengguna/store') }}" enctype="multipart/form-data" method="POST">
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_lengkap" placeholder="Nama Lengkap" value="{{ @$info ? @$info->nama_lengkap : '' }}">
									</div>
                                </div>
                            </div>
                        </div>
